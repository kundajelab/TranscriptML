...
def main() -> None:
    parser = argparse.ArgumentParser(description="Write a TranscriptML train config for one dataset split.")
    parser.add_argument("--dataset", required=True, help="TranscriptML dataset bundle")
