...
def main() -> None:
    parser = argparse.ArgumentParser(description="Write a fold-specific TranscriptML MPRA bundle and train config.")
    parser.add_argument("--dataset", required=True, help="Original TranscriptML MPRA dataset bundle")
    ...
    val_fold = (test_fold + int(args.val_offset)) % int(args.n_folds)
    train = []
